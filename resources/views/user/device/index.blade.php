               ...
               <div class="row">
                  ...
                  <div class="col-auto">
                     ...
                     <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item has-icon delete-confirm" href="javascript:void(0)" data-action="{{ url('user/device/delete',$device->uuid) }}"><i class="fas fa-trash"></i>{{ __('Remove Device') }}</a>
                     </div>
                  </div>
               </div>
               <p class="mt-3 mb-0 text-sm">
