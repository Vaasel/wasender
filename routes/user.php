...
Route::group(['prefix' => 'user', 'as' => 'user.', 'middleware' => ['auth','user','saas']], function (){
   ...
   //device routes
   Route::post('device/delete/{id}',  [USER\DeviceController::class, 'destroy']);
   Route::resource('device',               USER\DeviceController::class)->except(['destroy']);
   ...
   Route::get('/device/contacts/{uuid}',           [USER\ChatController::class,'contacts']);
   Route::post('/get-chats/{uuid}',             [USER\ChatController::class,'chatHistory']);
   Route::post('/get-chats-messages',             [USER\ChatController::class,'getChatMessages']);
   ...
   Route::get('send-group/jzcreate',                    [USER\BulkController::class,'jzcreate']);
   Route::get('/sent-bulk-with-template/{id}/{groupid}/{deviceid}', [USER\BulkController::class,'sendBulkToContacts']);
   Route::get('/get-group-contacts/{groupid}/{perpage}',                       [USER\BulkController::class,'getGroupContacts']);
